...
namespace CbtAdminPanel.Migrations
{
    ...
    [Migration("20240808121018_AssignModule")]
            ...
            modelBuilder.Entity("CbtAdminPanel.Models.Roles", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2024, 8, 8, 17, 40, 15, 506, DateTimeKind.Local).AddTicks(2276),
                            Name = "admin"
                        });
                });
            ...
            modelBuilder.Entity("CbtAdminPanel.Models.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountStatus = 0,
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2024, 8, 8, 17, 40, 15, 506, DateTimeKind.Local).AddTicks(2600),
